Pod::Spec.new do |s|
  ...
  s.source_files = 'CoreBitcoin', 'openssl/**/*.c', 'openssl/include/*.h', 'openssl/include/internal/*.h'
  ...
  s.requires_arc = true
  s.xcconfig = {
    'HEADER_SEARCH_PATHS' => '${PODS_ROOT}/CoreEthereum/openssl/include',
    'USER_HEADER_SEARCH_PATHS' => '${PODS_ROOT}/CoreEthereum/openssl/src/**'
  }

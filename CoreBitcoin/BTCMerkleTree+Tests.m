...
+ (void) runAllTests {
...

    {
        ...
        NSAssert([tree.merkleRoot isEqualTo:a], @"One-hash tree should have the root == that hash");
    }

    {
        ...
        NSAssert([tree.merkleRoot isEqualTo:r], @"Two-hash tree should have the root == Hash(a+b)");
    }

    {
        ...
        NSAssert([tree.merkleRoot isEqualTo:r], @"Root(a,b,c) == Hash(Hash(a+b)+Hash(c+c))");
    }

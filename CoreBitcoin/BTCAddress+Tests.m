...
+ (void) testPublicKeyAddress
{
    ...
    BTCPublicKeyAddress* addr2 = [BTCPublicKeyAddress addressWithData:[[NSData alloc] initWithHexString:@"c4c5d791fcb4654a1ef5e03fe0ad3d9c598f9827"]];
...
+ (void) testPrivateKeyAddress
{
    ...
    BTCPrivateKeyAddress* addr2 = [BTCPrivateKeyAddress addressWithData:[[NSData alloc] initWithHexString:@"c4bbcb1fbec99d65bf59d85c8cb62ee2db963f0fe106f483d9afa73bd4e39a8a"]];
    NSAssert(addr2, @"Address should be created");
...
+ (void) testScriptHashKeyAddress
{
    ...
    BTCScriptHashAddress* addr2 = [BTCScriptHashAddress addressWithData:[[NSData alloc] initWithHexString:@"e8c300c87986efa84c37c0519929019ef86eb5b4"]];
    NSAssert(addr2, @"Address should be created");
